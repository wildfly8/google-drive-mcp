...
- [X] T035 Add httpx Streamable HTTP contract tests that send `Authorization: Bearer` and assert missing/invalid bearer never reaches Drive I/O (plan: Streamable HTTP contract tests, AC-FR-010) (partial)
