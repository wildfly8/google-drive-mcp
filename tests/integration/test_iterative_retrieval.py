...
def test_iterative_find_read_grep_read_grep(runtime):
    found = handle_tool(
    ...
    read1 = handle_tool(runtime, "drive_read", {"file_id": file_id}, "Bearer test-token")
    ...
    read2 = handle_tool(runtime, "drive_read", {"file_id": file_id}, "Bearer test-token")
